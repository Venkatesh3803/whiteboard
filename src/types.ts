...
export type Layer = RectangleLayer | EllipseLayer | PathLayer | TriangleLayer | ImageLayer;
...
export type CanvasState =
  ...
  | {
    ...
    layerType: LayerType.Ellipse | LayerType.Rectangle | LayerType.Triangle | LayerType.Image;
  }
  | {
